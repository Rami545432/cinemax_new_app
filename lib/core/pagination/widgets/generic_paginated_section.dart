...
import 'package:movify/features/home/presentation/widgets/section_header.dart';
import 'package:movify/hooks/ui/use_pagintation_controller_test.dart';
import 'package:movify/shared/presentation/widgets/size_config.dart';
import 'package:movify/shared/presentation/widgets/vertical_film_card_loading.dart';
...
>
  ...
  Widget _buildHeader(BuildContext context) => SectionHeader<C, CAT, T, P>(
    category: category,
    title: title,
    ...
    return AspectRatio(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) =>
            const ShimmerLoading(child: VerticalFilmCardLoading()),
      ),
    );
  }
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return AnimatedListItem(
            index: index % 10,
            child: itemBuilder(items[index], enableHero),
          );
        },
      ),
    );
  ...
  Widget _buildSeeAllButton(BuildContext context) => Padding(
