...
class TmdbConfig {
  ...
  static const String appendToResponse = 'credits,videos,translations,reviews';
  ...
  static String get additionalData =>
      '$appendToResponse&include_image_language=$includeImageLanguage&include_video_language=$includeVideoLanguage';
